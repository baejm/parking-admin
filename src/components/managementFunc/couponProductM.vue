...
export default {
  data() {
    return {
      listItem: [
        { title: "번호" },
        { title: "할인쿠폰명", sortBy: false, standard: "coupon_name" },
        { title: "할인시간", sortBy: false, standard: "value" },
        { title: "할인ID", sortBy: false, standard: "couponID" },
        { title: "키맵", sortBy: false, standard: "keymap" },
        { title: "가격", sortBy: false, standard: "price" },
        { title: "판매상태", sortBy: false, standard: "saleing_state" },
  ...
  methods: {
    upDown_click: function(e) {
      ...
      if (e.sortBy === false) {
        ...
        e.sortBy = true
        temp10 = _.sortBy(this.coupon_product_list, e.standard)
        temp10.reverse()
        return (this.coupon_product_list = temp10)
      } else {
        e.sortBy = false
        temp10 = _.sortBy(this.coupon_product_list, e.standard)
        return (this.coupon_product_list = temp10)
