    ...
    <div class="list-items">
      ...
      <ul class="list-wrap">
        ...
        >
          ...
          /></span>
          <span class="groupName"
            ><input type="text" v-model="res.reduction_name" readonly
          /></span>
          <span class="groupName"
            ><input type="text" v-model="res.reduction_hour" readonly
          /></span>
          <span class="groupName"
            ><input type="text" v-model="res.reduction_value" readonly
          /></span>
          <span class="groupName"
            ><input type="text" v-model="res.reduction_unit" readonly
          /></span>
          <span class="contents"
            ><input
              type="text"
    ...
    changeTitle() {
      this.mainTitle.forEach(title => {
        title.subMenu.forEach(add => {
          if (add.add === "discountReductRec") this.titles = add.title
        })
      })
    },
    modifyClose() {
          ...
          if (obj.obj_in) {
            ...
            if (obj2.discounted_reduction_list) {
              console.log(
                ...
                obj2.discounted_reduction_list[0].paid_fee
              )
